...
const SIGNAL_PLAN_ENDPOINT_INDEPENDENT_NAT_TEST_NAME: &str =
    "udp_hole_puncher_uses_signal_plan_across_endpoint_independent_snat_network_namespaces";
...
const SIGNAL_PLAN_ASYMMETRIC_ADDRESS_PORT_DEPENDENT_NAT_TEST_NAME: &str =
    "udp_hole_puncher_does_not_traverse_signal_plan_asymmetric_address_port_dependent_snat_network_namespaces";
...
async fn udp_hole_puncher_uses_signal_plan_across_endpoint_independent_snat_network_namespaces(
    ...
    let topology = TwoSidedSnatTopology {
        private_second_octet: 253,
        public_third_octet: 11,
    ...
    run_two_sided_snat_hole_punch_topology_with_signal_plan(
        SIGNAL_PLAN_ENDPOINT_INDEPENDENT_NAT_TEST_NAME,
        "sigeinat",
        topology,
        plan_json.as_str(),
    )
...
async fn udp_hole_puncher_does_not_traverse_signal_plan_asymmetric_address_port_dependent_snat_network_namespaces(
    ...
    run_two_sided_snat_hole_punch_topology_with_signal_plan(
        SIGNAL_PLAN_ASYMMETRIC_ADDRESS_PORT_DEPENDENT_NAT_TEST_NAME,
        "sigasymapdnat",
        topology,
        plan_json.as_str(),
    )
...
async fn udp_hole_puncher_uses_signal_plan_across_one_sided_port_preserving_public_peer_snat_network_namespaces(
    ...
    let topology = OneSidedSnatTopology {
        label: "sigonepresnat",
        private_second_octet: 254,
        public_third_octet: 12,
        left_bind_port: 40101,
        left_reflexive_port: 40101,
        left_snat_port: None,
        right_bind_port: 40102,
    ...
    run_one_sided_snat_hole_punch_topology_with_signal_plan(
        SIGNAL_PLAN_ONE_SIDED_PORT_PRESERVING_NAT_TEST_NAME,
        topology,
        plan_json.as_str(),
    )
}
...
async fn udp_hole_puncher_does_not_traverse_signal_plan_one_sided_address_port_dependent_snat_network_namespaces(
    ...
    let topology = OneSidedSnatTopology {
        label: "sigoneapdnat",
        private_second_octet: 255,
        public_third_octet: 13,
        left_bind_port: 40101,
        left_reflexive_port: 50101,
        left_snat_port: Some(51101),
        right_bind_port: 40102,
    ...
    run_one_sided_snat_hole_punch_topology_with_signal_plan(
        SIGNAL_PLAN_ONE_SIDED_ADDRESS_PORT_DEPENDENT_NAT_TEST_NAME,
        topology,
        plan_json.as_str(),
    )
}
