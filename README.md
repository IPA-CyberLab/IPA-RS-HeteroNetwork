...
- agent JSON and Prometheus metrics for path state, relay admission, relay forwarders, lazy connect, and packet-flow activity plus bounded structured path-change event export
