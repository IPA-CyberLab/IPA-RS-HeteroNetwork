...
- expiring public-service leases that aggregate active Control Plane, Signal, STUN, Relay, and Web UI endpoints, including signed Agent-published STUN/Relay leases from nodes without local SQL, and expose HA readiness through the operator API, Prometheus, OTLP, and the Web UI
