...
- control-plane join service that verifies signed tokens, issuer keys, cluster/time validity, token-ledger admission, route policy, and relay-capability policy before registration
