...
The next production milestone is to add daemon binaries for relay and agent, then add network-namespace integration tests for direct, NAT traversal, and relay fallback paths.
