...
{{- else if or (contains "security-group" $key) (contains "securitygroup" $key) (contains "firewall" $key) (contains "security-list" $key) (contains "allowed-service-tags" $key) (contains "allowed-ip-ranges" $key) (contains "shared-securityrule" $key) -}}
