...
{{- else if or (contains "load-balancer-scheme" $key) (contains "loadbalancer-scheme" $key) (contains "load-balancer-internal" $key) (contains "loadbalancer-internal" $key) (contains "internal-load-balancer" $key) (contains "load-balancer-type" $key) (contains "loadbalancer-type" $key) (contains "load-balancer-address-type" $key) (contains "loadbalancer-address-type" $key) (contains "load-balancer-class" $key) (contains "loadbalancerclass" $key) (contains "nlb-target-type" $key) (contains "l4-rbs" $key) (contains "global-access" $key) (contains "allow-global-access" $key) -}}
...
{{- else if or (contains "traffic-distribution" $key) (contains "traffic_distribution" $key) (contains "weighted-load-balancing" $key) (contains "load-balancing-policy" $key) (contains "loadbalancing-policy" $key) (contains "load-balancing-algorithm" $key) (contains "traffic-policy" $key) (contains "traffic_policy" $key) -}}
