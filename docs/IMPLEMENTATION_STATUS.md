...
- Lazy connect and pinning runtime support in the agent crate, including peer activity recording, policy/route/relay/path pins, and idle peer removal during peer-map application.
