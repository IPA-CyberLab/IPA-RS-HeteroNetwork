...
Run the real attach and ring-buffer event gate on a privileged Linux host with tracefs. The cgroup gate asserts TCP connect and UDP send-message delivery for both IPv4 and IPv6, including UDP source and destination addresses and ports:
